...
<main class="d-flex flex-grow-1 w-100">
     <!-- Section -->
     <section class="d-flex align-items-center bg-secondary w-100">
        <div class="container">
            <div class="col-12 col-lg-6 mb-4 mb-lg-0">
                <div class="card card-tertiary">
                    ...
                    <div class="card-body">
                        <h4>Welcome to UIUCTF 2023</h4>
                        <div class="d-flex mt-3 flex-column">
                            <div class="d-flex flex-row">
                                
                                <div class="bg-light-yellow d-flex flex-column p-3 overflow-scroll w-100">
                                    {#if selected == "about"}
...
<footer class="d-flex">
    <nav id="navbar-footer" class="navbar navbar-main navbar-expand-lg navbar-dark justify-content-between navbar-footer">
        <ul class="navbar-nav navbar-nav-hover flex-row align-items-center">
            <li class="nav-item">
                <div class="nav-link">
                    <img src="/images/windows-95-start.png" alt="" style="opacity: 100% !important">
                </div>
            </li>
        </ul>
